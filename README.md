...
You can also use [this interactive TUI app](https://github.com/nholuongut/TUI-apps/blob/main/AwkExercises) to practice some of the exercises from the book.
...
* You can purchase the pdf/epub versions of the book using these links:
    * https://nholuongut.gumroad.com/l/gnu_awk
    * https://leanpub.com/gnu_awk
* You can also get the book as part of these bundles:
    * **All books bundle** bundle from https://nholuongut.gumroad.com/l/all-books
        * Includes all my programming books
    * **Magical one-liners** bundle from https://nholuongut.gumroad.com/l/oneliners or https://leanpub.com/b/oneliners
    * **Awesome Regex** bundle from https://nholuongut.gumroad.com/l/regex or https://leanpub.com/b/regex
* See https://nholuongut.github.io/books/ for a list of other books

For a preview of the book, see [sample chapters](./sample_chapters/gnu_awk_sample.pdf).

The book can also be [viewed as a single markdown file in this repo](./gnu_awk.md). See my blogpost on [generating pdfs from markdown using pandoc](https://nholuongut.github.io/customizing-pandoc/) if you are interested in the ebook creation process.

For the web version of the book, visit https://nholuongut.github.io/learn_gnuawk/
